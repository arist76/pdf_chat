      ...
      <ul class="mt-16 space-y-5">
        ...
        <li class="max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4">
          <div class="flex-shrink-0 w-[2.375rem] h-[2.375rem] rounded-full">
            <img src="{aiSparkle}" alt="AI sparkle" class="w-full h-full">
          </div>
  
          <div class="space-y-3">
            <div class="space-y-1.5">
              <p class="mb-1.5 text-sm text-gray-800 dark:text-white">
                You have selected the mathematics section for grade 10, you can ask questions like:
              </p>
              <ul class="list-disc list-outside space-y-1.5 ps-3.5">
                ...
                <li class="text-sm text-gray-800 dark:text-white">
                  Give me an example question of derivatives?
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            ...
            <div class="space-y-3">
              <p class="text-sm text-gray-800 dark:text-white">
                The chain rule states that to compute the derivative of f ∘ g ∘ h, it is sufficient to compute the derivative of f and the derivative of g ∘ h. The derivative of f can be calculated directly, and the derivative of g ∘ h can be calculated by applying the chain rule again.              </p>
              <div class="space-y-1.5">
                <p class="text-sm text-gray-800 dark:text-white">
                ...
                <ul>
                  <li>
                    <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="">
                      Chain rule wikipedia page
                    </a>
                  </li>
                  <li>
                    <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="">
                      Chain rule on khan academy
                    </a>
                  </li>
                </ul>
              </div>
    ...
    <div class="sticky bottom-0 z-10 bg-white border-t border-gray-200 pt-2 pb-3 sm:pt-4 sm:pb-6 dark:bg-slate-900 dark:border-gray-700">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-3">
          <!-- <button type="button" class="inline-flex justify-center items-center gap-x-2 rounded-lg font-medium text-gray-800 hover:text-blue-600 text-xs sm:text-sm dark:text-gray-200 dark:hover:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
        ...
        <!-- Input -->
        <div class="relative">
          <textarea class="p-4 pb-12 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Ask me anything..."></textarea>
